...
|img-5| The backend is divided into  **three columns** (see Figure 2). By
...
The third column [3] is the  **work area** . The fourth area [4] will
only be there if you are using version 4.2 or higher, it is called
