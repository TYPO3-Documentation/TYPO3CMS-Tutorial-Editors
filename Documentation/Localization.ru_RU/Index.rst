...
После установки TYPO3, как описано в :doc:`Ознакомительном пособии / Getting Started Guide <t3start:Index>`, необходимо войти во внутренний интерфейс CMS, начать добавлять страницы и создавать содержимое. В мире TYPO3 принято называть пользователей, выполняющих эти задачи, "редакторами".
