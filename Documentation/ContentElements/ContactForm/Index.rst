...
written in TypoScript and is fully documented in the :ref:`Form Framework <ext_form:start>` system extension manual.
...
.. tip::
   ...
   described in the :ref:`"Form Framework" <ext_form:start>` system extension
   manual.
