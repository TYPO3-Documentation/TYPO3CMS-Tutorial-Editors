...
*   Text for :ref:`accessibility <accessibility>` such as the :guilabel:`alternative text`
...
..  figure:: /Images/ManualScreenshots/FilelistModule/CreateFolder.avif
    :zoom: lightbox
    :alt: A section of TYPO3 Filelist Module open and overlayed with the module dialog for
